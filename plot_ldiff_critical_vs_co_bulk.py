...
от концентрации кислорода в объеме жидкого свинца при T = 620 °C.
...
OUTPUT_PNG = "ldiff_critical_vs_co_bulk.png"
FIG_DPI = 220
...
def make_plot() -> Path:
    ...
    c_o_bulk_mol = np.logspace(-4, 2.2, 600)
    ...
    ax.set_title(r"Критическая толщина $l_{diff}^{*}$ как функция $C_O^{bulk}$")
