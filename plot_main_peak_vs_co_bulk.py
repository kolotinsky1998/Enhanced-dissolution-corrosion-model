...
от концентрации кислорода в объеме жидкого свинца.

На график наносятся:
1. численные точки по результатам расчетов;
2. аналитическая кривая

    z_max = l / (1 + (C_O_bulk / C_Fe_s) * (D_O / D_Fe)).
...
OUTPUT_PNG = "main_peak_vs_co_bulk.png"
FIG_DPI = 220


# ============================================================
# Численные точки из логов расчета
# C_O_bulk дан в mol/m^3, положение главного пика — в m
# ============================================================
...
def make_plot() -> Path:
    ...
    ax.set_title("Положение главного пика потока магнетита")
